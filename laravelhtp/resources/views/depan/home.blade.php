         ...
         <div class="row align-items-center px-3">
             <div class="col-lg-6 text-center text-lg-left">
                 ...
                 <p class="text-white mb-4">
                   Lorem, ipsum dolor sit amet consectetur adipisicing elit. Suscipit quo, consectetur quaerat harum magnam praesentium ea odio illum repellendus quisquam nulla ex ullam atque iste placeat, nam iusto totam. Consequuntur!
                 </p>
                 <a href="{{ url("/pendaftaran") }}" class="btn btn-secondary mt-1 py-3 px-5">Daftar sekarang</a>
             </div>
             <div class="col-lg-6 text-center text-lg-right">
                 <img class="img-fluid mt-5" src="{{ asset("depan/img/header.png") }}" alt="" />
             </div>
         </div>
     </div>
     <!-- Header End -->
     ...
     <div class="container-fluid py-5">
         <div class="container">
             <div class="row align-items-center">
                 <div class="col-lg-5">
                     <img class="img-fluid rounded mb-5 mb-lg-0" src="{{ asset("depan/img/about-1.jpg") }}" alt="" />
                 </div>
                 <div class="col-lg-7">
                     ...
                     <div class="row pt-2 pb-4">
                         <div class="col-6 col-md-4">
                             <img class="img-fluid rounded" src="{{ asset("depan/img/about-2.jpg") }}" alt="" />
                         </div>
             ...
             <div class="row">
                 <div class="col-lg-4 mb-5">
                     <div class="card border-0 bg-light shadow-sm pb-2">
                         <img class="card-img-top mb-2" src="{{ asset("depan/img/class-1.jpg") }}" alt="" />
                 ...
                 <div class="col-lg-4 mb-5">
                     <div class="card border-0 bg-light shadow-sm pb-2">
                         <img class="card-img-top mb-2" src="{{ asset("depan/img/class-2.jpg") }}" alt="" />
                         <div class="card-body text-center">
                 ...
                 <div class="col-lg-4 mb-5">
                     <div class="card border-0 bg-light shadow-sm pb-2">
                         <img class="card-img-top mb-2" src="{{ asset("depan/img/class-3.jpg") }}" alt="" />
                         <div class="card-body text-center">
         ...
         <div class="container p-0">
             ...
             <div class="owl-carousel testimonial-carousel">
                 ...
                 <div class="testimonial-item px-3">
                     ...
                     <div class="d-flex align-items-center">
                         <img class="rounded-circle" src="{{ asset("depan/img/testimonial-5.jpg") }}" style="width: 70px; height: 70px"
                             alt="Image" />
                         <div class="pl-3">
                             <h5>Parent Name</h5>
                             <i>Profession</i>
