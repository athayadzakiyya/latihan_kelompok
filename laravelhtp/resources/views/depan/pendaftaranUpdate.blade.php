    ...
    <div class="content-wrapper d-flex justify-content-center align-items-center">
        <div class="container-xxl flex-grow-1 container-p-y">
            ...
            <div class="row justify-content-center">
                <div class="col-md-6">
                    <div class="card mb-4">
                        <h5 class="card-header">Upadate data pendaftaran</h5>
                        <div class="card-body p-5">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-8">
                                        <input id="nm_panggilan" name="nm_panggil" placeholder="Masukan nama..."
                                            type="text" class="form-control" value="Mirlani">
                                    </div>
                                </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    <label for="dat" class="col-4 col-form-label">Tahun Ajar</label>
                                    <div class="col-8">
                                       
                                        <input id="text" name="thn_ajar" type="text" class="form-control" value="2020">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="foto_anak" class="col-4 col-form-label">Foto anak</label>
                                    <div class="col-8">
                                        <input id="foto_anak" name="foto_anak" type="file" class="form-control" value="lani.pdf">
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    <div class="text-center mt-5 d-flex justify-content-center">
                                        ...
                                        <a href="{{ url('/pendaftarandetail') }}"> 
                                            <button type="button"
                                                class="btn btn-primary fw-semibold px-5  py-2 mx-3">Update </button> </a>
                                    </div>
                                </div>
                            </form>
